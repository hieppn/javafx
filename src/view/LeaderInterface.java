...
public class LeaderInterface extends Stage {
	public static boolean stateLeader = false;

	public LeaderInterface() {
		...
		//Image imageLeader = new Image(getClass().getResourceAsStream("/leader7.PNG"));
		Label leader = new Label();
		//leader.setGraphic(new ImageView(imageLeader));
		//leader.setMaxWidth(5000);
		leader.setText("WELCOME TO LEADER PAGE");
		...
		String str = "                  You are a leader. You can manage employees and projects.\n"
		...
		Image imageForm = new Image(getClass().getResourceAsStream("/leader.png"));
		Scene scene = new Scene(grid);
		scene.getStylesheets().add("application.css");
		this.setTitle("Leader Form");
